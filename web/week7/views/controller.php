...
//    }
    ...
    while ($row = $statement2->fetch(PDO::FETCH_ASSOC))
    {
      ...
      $collection .= "<input type='submit' class='btn btn-danger' title='Click to Delete'><i class='fas fa-trash-alt fa-fw'></i></input>"; // input not button - but how do you submit then with no submit button?
      $collection .= '</div>';
      $collection .= '</td>';
      $collection .= '</tr>';
    }
